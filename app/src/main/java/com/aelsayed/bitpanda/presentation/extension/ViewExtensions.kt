package com.aelsayed.bitpanda.presentation.extension
...
import com.aelsayed.bitpanda.presentation.base.util.GlideApp
...
fun Double.roundToXDecimal(precision: Int): String {
